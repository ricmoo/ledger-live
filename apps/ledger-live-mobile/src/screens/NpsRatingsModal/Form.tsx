...
ratingOptions.forEach((option) => {
  option.addEventListener('click', () => {
    const rate = option.getAttribute('data-value-number');
      ...
      if (data === "form-submit") {
        ...
        if (!selectedRate || selectedRate <= 7) {
          ...
          screen(
            ...
            { page: "NPS Step 2 not Happy", source: ratingsHappyMoment?.route_name },
            true,
          );
        } else {
          setStep("enjoy");
          screen(
            "",
            "NPS Step 2 Happy",
            { page: "NPS Step 2 Happy", source: ratingsHappyMoment?.route_name },
            true,
          );
        }
      }
